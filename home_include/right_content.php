 <div id="dangnhap">
					<div class="center1">
						<h4>ĐĂNG NHẬP</h4>
						<?php if(isset( $_SESSION['username']) && isset($_SESSION['phanquyen'])){
								if($_SESSION['phanquyen'] == 0){ ?>
								<div id="dangnhap-in">

									<span id="xinchao"><p>Xin chào:<span> <a href="admin/admin.php"><?php echo $_SESSION['username'] ?></a> </span></p></span>
							...
							<?php } else{ ?>
								...
								<div id="dangnhap-in">
									...
									<span id="xinchao"><p>Xin chào:<span>  <a href="nguoidung/nguoidung.php"><?php echo $_SESSION['username'] ?></a> </span></p></span>
									<span id="logout"><p><a href="logout.php">Logout</a></p></span>
